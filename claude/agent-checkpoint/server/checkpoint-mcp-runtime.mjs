...
// explicit unknowns. Internal IDs, sidecar fields, and remaining tokens are
...
// Returns { contextUsed, remainingKTokens, sessionTitle }; every field is
...
// remaining K-tokens approximate max(0, context_window_size -
