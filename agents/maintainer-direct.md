---
description: Non-interactive orchestrator for proportional planning and gated implementation; persists work in docs/ and plans/ when durable coordination is needed.
mode: primary
hidden: false
permission:
  question: allow
