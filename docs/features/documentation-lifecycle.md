...
| [Agent Personas](../modules/agent-personas.md) | `maintainer` agent routing (`agents/maintainer.md:115`) | Selects the workflow and delegates the codebase-anchored writing task. |
