...
| OpenCode Checkpoint Adapter | Native tools, agent/title snapshots, previous-completed-step context/used/headroom estimates, independent honest fallbacks, and OpenCode-only persona instruction. | [Detail](modules/opencode-checkpoint-adapter.md) |
